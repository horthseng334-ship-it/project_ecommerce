...
import { IceCream, PaintBucket, SunDimIcon } from "lucide-react";
import { SiContensis } from "react-icons/si";
import { BiWater } from "react-icons/bi";
import { FaPumpSoap, FaSpa, FaTint } from "react-icons/fa";
        ...
        <div className="min-h-screen bg-gray-50 pt-24 pb-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="">
                    ...
                    {/* ================= SIDEBAR ================= */}
                    <aside className="w-full lg:w-64 shrink-10">
                    ...
                    <main className="flex-1">
                        ...
                        <div className="grid grid-cols-7 gap-5 mb-7 p-6">
